...
namespace CloudNext.Services
{
    public class UserService : IUserService
    {
        ...
        public async Task<(User?, string Token, string Message)> AuthenticateUserAsync(string email, string password)
        {
            ...
            await _userSessionService.SetSession(user.Id, decryptedUserKey);
        ...
        public async Task<RegisterResult?> RegisterUserAsync(string email, string password)
        {
            ...
            await _userSessionService.SetSession(userId, encryptionKey);
        ...
        {
            await _userSessionService.RemoveSession(userId);
        }
